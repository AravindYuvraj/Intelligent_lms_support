...
import { LayoutDashboard, Bell, BookOpen, Users, MessageSquare, HelpCircle, Search, Settings, LogOut, ChevronLeft, MoreHorizontal, Bookmark, FileText } from 'lucide-react'
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navigationItems = [
    ...
    { icon: BookOpen, label: 'Blended Learning', href: '/blended-learning' },
    { icon: FileText, label: 'Assignments', href: '/assignments' },
    { icon: HelpCircle, label: 'Quiz', href: '/quiz' },
    { icon: Users, label: 'Discussions', href: '/discussions' },
    { icon: Users, label: 'MasaiVerse - Community', href: '/community' },
    { icon: Users, label: 'Changemakers Circle', href: '/changemakers' },
